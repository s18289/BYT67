...
public class Money implements Comparable {
	...
	public Money add(Money other) {
		int temp = this.currency.valueInThisCurrency(other.amount, other.currency);
		return new Money(amount + temp, currency);
	}
	...
	public int compareTo(Object other) {
		...
		if(universalValue().intValue() == money.universalValue().intValue()){
			return 0;
		} else if(universalValue().intValue() < money.universalValue().intValue()){
			return -1;
		} else {
			return 1;
		}
